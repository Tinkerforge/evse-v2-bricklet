...
// --- Basic defines ---
#define BOOTLOADER_DEVICE_IDENTIFIER   2167
#define BOOTLOADER_HW_VERSION_MAJOR    1
#define BOOTLOADER_HW_VERSION_MINOR    0
#define BOOTLOADER_HW_VERSION_REVISION 0

#define BOOTLOADER_STATUS_LED_PIN      P0_6

#define BOOTLOADER_BOOT_PAD_DEP_PIN    P4_5
#define BOOTLOADER_BOOT_PAD_HIGH_PIN   P0_7
#define BOOTLOADER_BOOT_PAD_LOW_PIN    P0_4
