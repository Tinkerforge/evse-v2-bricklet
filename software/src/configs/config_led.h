...
#define EVSE_V3_LED_R_PASSIVE_LEVEL XMC_CCU8_SLICE_OUTPUT_PASSIVE_LEVEL_HIGH
...
#define EVSE_V3_LED_G_PASSIVE_LEVEL XMC_CCU8_SLICE_OUTPUT_PASSIVE_LEVEL_LOW
...
#define EVSE_V3_LED_B_PASSIVE_LEVEL XMC_CCU8_SLICE_OUTPUT_PASSIVE_LEVEL_HIGH
